...
A similar approach can be used for reports. For example, below HexSimR calculates the descriptive statistics for the movement's and ranges' reports (after these were generated. See 'HexSimR utilities' if you want to have a look on how to quickly generate those). 

__RUN THIS CODE CHUNK AFTER REPORTS ARE INSERTED__
...
Firstly, you have to create an array of hexagons. As mentioned before, I have created a linear array (__Figure...__). 
