...
Just to make sure no one gets confused, pay attention to the fact that when I use "HexSim" (no "R"), I am referring to the fantastic piece of software developed by Nathan Schumaker (Schumaker N, HexSim (Version 3 & 4). US Environmental Protection Agency. Environmental Research Laboratory, Corvallis, Oregon. [https://www.hexsim.net/](https://www.hexsim.net/)). When I use "HexSimR", I am referring to this R package.  
